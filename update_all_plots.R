...
# Fig 3 (Faceted, no legend title, alpha 0.4 error bars)
source("update_plotting_faceted_correct.R") # Re-using model calc logic
# Inject new plot code with alpha=0.4
