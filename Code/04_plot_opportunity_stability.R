...
# Save Plot
ggsave(here("Plots", "fig-opportunity-stability.png"), width = 7, height = 4.5, dpi = 300)
cat("Opportunity stability plot successfully generated and saved to Plots/fig-opportunity-stability.png\n")
