...
for (w in paste0("Wave", 3:8)) {
  ...
  m_w <- glm(same_religion ~ ego_rel + gender_1 + race_1 + close, family = binomial, offset = opportunity_offset, data = df_w)
...
ggsave("Plots/fig-active-coefs.png", p_coef, width = 8, height = 6)
